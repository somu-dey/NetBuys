  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        // const docRef = doc(database, "RegisteredUsers", sellerId);
        ...
        <>
          ...
          >
            ...
            >
              ...
              >
                <h4 style={{ textDecoration: "underline", marginTop: "1rem" }}>
                  SELLER INFORMATON
                </h4>
                <div
                  className="d-flex"
        ...
        >
          ...
          >
            <div className="d-flex flex-column">
              <h6>Price</h6>
              <h3> ₹{finalData?.price}</h3>
            </div>
            <div className="d-flex flex-column">
              <h6>
                <FaLocationArrow /> Location
              </h6>
              <h3>{finalData?.location}</h3>
            </div>
            <div className="d-flex flex-column">
              <h6>
                <FaHeart />
