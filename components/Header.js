          ...
          {isDropdownOpen && userExists ? (
            ...
            >
              ...
              >
                ...
                >
                  <li>
                    <Link className="nav-link listview" to="/profile">
                      My Profile
                    </Link>
                  </li>
                  <li>
                    <Link className="nav-link listview" to="/myads">
                      My Ads
                    </Link>
                  </li>
                  {/* <li>
                  ...
                  <li>
                    <Link className="nav-link listview" to="/chatUsers">
                      My Chats
                    </Link>
                  </li>
                  <li>
                    <Link
                      className="nav-link listview"
                      to="#"
                      onClick={handleLogout}
                    >
                      Logout
